...
datadir=/home/marcoyang/Downloads/librispeech
...
expname=train_${train_set}_${backend}_${tag}
expdir=exp/${expname}
mkdir -p ${expdir}
train_dir=/home/marcoyang/Downloads/librispeech_finetuning/1h
valid_dir=/home/marcoyang/Downloads/librispeech/LibriSpeech/dev-clean
dict=./train_units.txt
...
if [ ${stage} -le 4 ] && [ ${stop_stage} -ge 4 ]; then
    ...
    ${cuda_cmd} --gpu ${ngpu} ${expdir}/train.log \
        ...
        --verbose ${verbose} \
        --resume ${resume} \
        --train-json ${train_dir}/data_w2v2.json \
        --valid-json ${valid_dir}/data_w2v2.json
fi
