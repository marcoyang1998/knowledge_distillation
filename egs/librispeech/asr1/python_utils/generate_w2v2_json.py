...
def generate_w2v2_json_input(dataset_dir, dict_dir, ext, output_dir, odim, kd_folder):
    ...
    print("Finish writing {} utterances to {}".format(len(json_dict['utts']), os.path.join(output_dir, "data_w2v2.json")))
    with open(os.path.join(output_dir, "data_w2v2.json"),'w',encoding='utf8') as f:
